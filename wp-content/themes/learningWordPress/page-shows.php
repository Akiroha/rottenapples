...
// ON AIR
$json_url = file_get_contents("https://api.themoviedb.org/3/tv/on_the_air?page=" . $page_num . "&language=en-US&api_key=4d7db88e6e8c175e817c6df85dc40313");
	...
	<div class="site-content clearfix">
		...
		<div class="show-column">
			...
			<div class="show-navigation">
				...
				<?php if($page_num != 1) { ?>
					<a href="/shows?page_num=1">First Page</a>
				<?php } ?>
				<?php if($page_num > 1) { ?>
					<a href="/shows?page_num=<?php echo $page_num - 1; ?>">Previous</a>
				<?php } ?>
				</div>
				
				<div class="next-button">
				<?php if($page_num < $json_a['total_pages']) { ?>
					<a href="/shows?page_num=<?php echo $page_num + 1; ?>">Next</a>
				<?php } ?>
				<?php if($page_num != $json_a['total_pages']) { ?>
					<a href="/shows?page_num=<?php echo $json_a['total_pages']; ?>">Last Page</a>
				<?php } ?>
				</div>
			</div>
